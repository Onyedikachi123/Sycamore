<template>
  <div class="login">
    ...
    <!-- <v-container fluid style="position: absolute; top: 0"> -->
    <v-container>
      <v-row>
              ...
              <v-row no-gutters>
                <v-col cols="4 sidebar">
                    ...
                    <v-list-item v-for="(item, i) in LoginItems" :key="i">
                      <v-list-item-icon>
                        <v-btn
                          ...
                          :style="{
                            background: 'white',
                            boxShadow: '0 0 8px 0 #ccc !important',
                          }"
                        >
                          <v-icon
                            color="green"
                  ...
                  <div class="left-footer">
                    <p style="font-size: 12px;padding: 0px 10px;">
                  ...
                  <div class="wrapper">
                    ...
                    <ValidationObserver ref="observer">
                      ...
                      >
                        ...
                        >
                          <div class="item">
                            <label class="label mt-8">Password</label>
                            <div
                              class="control has-icons-right is-medium"
                              data-v-4f8f839e
                            >
                              <input
                                :type="inputType"
                              ...
                              <span
                                @click="changeType"
                                class="icon is-right is-clickable pt-5"
                                style="color: grey"
                                ><i
                                  v-if="inputType == 'password'"
                                  class="mdi mdi-eye mdi-24px"
                                ></i>
                                <i v-else class="mdi mdi-eye-off mdi-24px"></i>
                              </span>
                            </div>
                            <span class="text-danger">{{ errors[0] }}</span>
                          </div>
                        ...
                        >
                          <div
                            class="mt-5"
                            style="font-size: 15px; color: #a4ae9d"
                          >
                            <p
                              class="mt-5"
                              style="font-size: 15px; color: #a4ae9d"

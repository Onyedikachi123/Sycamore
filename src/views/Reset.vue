<template>
  <div class="register" style="height: 100%; margin-top: -24px">
    <v-snackbar
      fixed
      top
      color="secondary"
    ...
    <v-row no-gutters style="height: 100%">
      <v-col cols="3" md="3" style="background: #f9f9f9">
        <v-col align="center" cols="6" xs="6" sm="6" md="6" class="mt-8">
          <router-link to="/">
            <v-img
              alt="Sycamore Logo"
              contain
        ...
        <v-col cols="5" xs="6" sm="6" md="9" style="margin-top: 50%">
          <v-list-item-group>
            <v-list-item>
              <v-list-item-icon>
                <v-btn
              ...
              <v-list-item-content>
                <v-list-item-title
                  ...
                  >Recover Password</v-list-item-title
                >
              </v-list-item-content>
            </v-list-item>
        ...
        <div class="ml-8" style="color: grey; font-size: 12px; margin-top: 90%">
          <span>Privacy | </span>
      ...
      <v-col sm="12" md="9">
        <div class="wrapper" style="height: 100%;">
          <form @submit.prevent="onSubmit()" class="col-md-9 offset-md-1">
            ...
            <div class="item">
              ...
              <input
                type="number"
                name="name"
                class="input is-medium m-0 py-6"
              />
            </div>
            ...
            <div style="display: flex; margin-top: 30px">
              <button class="back" type="submit" style="font-size: 14.26px">
                <a href="/password" style="color: #000; text-decoration: none">
                  BACK
                </a>
                <v-icon right color="#000"> mdi-chevron-right </v-icon>
              </button>

              <v-spacer></v-spacer>
              <button type="submit" style="font-size: 14.26px">
